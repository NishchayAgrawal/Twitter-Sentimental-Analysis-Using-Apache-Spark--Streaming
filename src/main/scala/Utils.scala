...
import scala.io.{AnsiColor, Source} // https://www.scala-lang.org/api/current/scala/io/AnsiColor.html

object Utils {

  // Some type aliases to give a little bit of context
  type Tweet = Status // User defined Type
  ...
  def keepMeaningfulWords(sentence: Sentence, uselessWords: Set[String]): Sentence =
    sentence.filterNot(word => uselessWords.contains(word))  //  remove useless words from sentences......
